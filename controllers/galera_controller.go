...
// +kubebuilder:rbac:groups=database.dciabrin.net,resources=galeras,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=database.dciabrin.net,resources=galeras/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=database.dciabrin.net,resources=galeras/finalizers,verbs=update
...
func (r *GaleraReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("galera", req.NamespacedName)
